...
nmap Îw <C-Home>
vmap Îw <C-Home>
cnoreabbr "make" "mingw32-make.exe"
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
...
set laststatus=2
set lazyredraw
set runtimepath=~/vimfiles,~\\.vim\\plugged\\vimdiscord,~\\.vim\\plugged\\nerdtree,~\\.vim\\plugged\\vim-devicons,C:\\Program\ Files\ (x86)\\Vim/vimfiles,C:\\Program\ Files\ (x86)\\Vim\\vim82,C:\\Program\ Files\ (x86)\\Vim/vimfiles/after,~/vimfiles/after
set shiftwidth=4
set smartcase
set smartindent
set smarttab
...
wincmd w
argglobal
terminal ++curwin ++cols=160 ++rows=14 ++type=winpty 
...
silent! normal! zE
let &fdl = &fdl
let s:l = 90 - ((31 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 90
