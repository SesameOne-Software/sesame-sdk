...
typedef struct {
	bool ( __thiscall* should_hit_entity ) ( itrace_filter*, entity*, int );
	trace_type ( __thiscall* get_trace_type ) ( itrace_filter*, entity*, int );
} itrace_filter;
...
VIRTUAL ( itrace, int, get_point_contents, 0, ( this, pos, mask, ent ), vec3* pos, trace_mask mask, entity* ent );
